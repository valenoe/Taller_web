...
class Horas(models.Model):
    ...
    def __str__(self):
        return "{} {} {}".format(self.fecha, self.hora, self.id_medico)
...
class Cita(models.Model):
    ...
    id_horario = models.ForeignKey(Horas, on_delete=models.RESTRICT)
    ...
    def __str__(self):
        return "{} {}".format(self.rut_paciente, self.id_horario)


class DatosAtencion(models.Model):
    id_cita = models.ForeignKey(Cita, on_delete=models.RESTRICT)
